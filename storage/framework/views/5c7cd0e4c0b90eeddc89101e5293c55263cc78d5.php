...
<title>登录</title>
<link rel="stylesheet" href="<?php echo e(asset('login/css/normalize.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('login/css/login.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('login/css/sign-up-login.css')); ?>">
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('login/css/font-awesome.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('login/css/inputEffect.css')); ?>" />
<link rel="stylesheet" href="<?php echo e(asset('login/css/tooltips.css')); ?>" />
<link rel="stylesheet" href="<?php echo e(asset('login/css/spop.min.css')); ?>" />

<script src="<?php echo e(asset('login/js/jquery.min.js')); ?>"></script>
<script src="<?php echo e(asset('login/js/snow.js')); ?>"></script>
<script src="<?php echo e(asset('login/js/jquery.pure.tooltips.js')); ?>"></script>
<script src="<?php echo e(asset('login/js/spop.min.js')); ?>"></script>
<script>
	(function() {
...
body{
	...
	background-image: url(<?php echo e(asset('login/images/snow.jpg')); ?>);
			...
			<div class="login sign-up-htm">
				<form action="#" method="post" class="container offset1 loginform">
					...
					<div class="pad input-container">
						<section class="content">
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" name="name" type="text" id="register-username"
							...
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" name="password_confirmation" type="password" id="register-repassword" placeholder="请确认密码" maxlength="15"/>
